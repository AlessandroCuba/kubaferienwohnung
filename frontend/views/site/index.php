...
$this->title = Yii::t('app', 'A lo Kubano');
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'A lo Kubano'), 'url' => ['index']];
?>
...
<!-- HERO SECTION -->
        ...
        <?php
                ...
                $container = ['class' => 'hero-section'];
                $wrapper = ['id' => 'slider-revolution'];
                $ulOptions = ['class' => ''];

                $slides = [
                    [
                        'options' => ['data' => ['transition' => 'fade', 'slotamount' => '7', 'duration'=>'14000', 'masterspeed' => '500']],
                        'image' => [
                            'src' => yii::getAlias('@imgKuba').'/bg/3.jpg', 
                            'options' => [
                                'alt' => 'slidebg1', 
                                'data' => ['bgpositionend' => 'right center', 'bgposition' => 'left center', 'bgrepeat' => 'no-repeat']
                            ]
                        ],
                        'layers' => [
                            [
                                'options' => [
                                    ...
                                    'data' => ['x' => 'center', 'y' => '230', 'speed' => '700', 'start' => '1500', 'easing' => 'easeOutBack'], 
                                    'style' => 'z-index: 6'
                                ],
                                'content' => 'Vivir Cuba'
                            ],
                            [
                                'options' => [
                                    ...
                                    'data' => ['x' => 'center', 'y' => '295', 'hoffset' => '0', 'voffset' => '-50', 'speed' => '2500', 'start' => '1800', 'easing' => 'Power4.easeOut', 'endspeed' => '300', 'captionhidden' => 'off'], 'style' => 'z-index: 6'],
                                'content' => 'A lo cubano!!!',
                            ],
                        ],
                    ],
                    [
                        'options' => ['data' => ['transition' => 'fade', 'slotamount' => '7', 'duration'=>'14000', 'masterspeed' => '500']],
                        'image' => [
                            'src' => yii::getAlias('@imgKuba').'/bg/1.jpg', 
                            'options' => [
                                'data' => ['bgpositionend' => 'right center', 'bgposition' => 'left center', 'bgrepeat' => 'no-repeat']
                            ]
                        ],
                        'layers' => [
                            [
                                'options' => [
                                    ...
                                    'data' => ['x' => 'center', 'y' => '200', 'speed' => '700', 'start' => '1500', 'easing' => 'easeOutBack'], 
                                ],
                                'content' => 'LebenKuba'
                            ],
                            [
                            ...
                            [
                                'options' => [
                                    'class' => '', 
                                    'data' => ['x' => 'center', 'y' => '370', 'speed' => '700', 'start' => '2200', 'easing' => 'Power4.easeOut', 'endspeed' => '300', 'captionhidden' => 'off'], 'style' => 'z-index: 6'],
                                'content' => '<a href="#" class="tp-caption sft fadeout awe-btn awe-btn-style3 awe-btn-slider" data-x="center" data-y="370" data-easing="easeOutBack" data-speed="700" data-start="2200">Book now</a>'
                            ],
                        ],
                    ],
                    [
                        'options' => ['data' => ['transition' => 'fade', 'slotamount' => '7', 'masterspeed' => '500']],
                        'image' => [
                            'src' => yii::getAlias('@imgKuba').'/bg/2.jpg', 
                            'options' => [
                                'alt' => 'slidebg1', 
                                'data' => ['bgfit' => 'cover', 'bgposition' => 'left center', 'bgrepeat' => 'no-repeat']
                            ]
                        ],
                        'layers' => [
                            [
                                'options' => [
                                    'class' => 'tp-caption sfb fadeout slider-caption-sub slider-caption-sub-2', 
                                    'data' => ['x' => 'center', 'y' => '190', 'speed' => '700', 'start' => '1500', 'easing' => 'easeOutBack'], 
                                    'style' => 'z-index: 6'
                                ],
                                'content' => 'Check out the top weekly destination'
                            ],
                            [
                                'options' => [
                                    'class' => 'tp-caption sft fadeout slider-caption slider-caption-2', 
                                    'data' => ['x' => 'center', 'y' => '220', 'start' => '2000', 'speed' => '700', 'easing' => 'easeOutBack']],
