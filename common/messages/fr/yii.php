...
return [
    ...
    'Are you sure you want to delete this item?' => 'Está seguro que desea borrar la entrada?',
    'Delete' => 'Borrar',
    'Error' => '',
    'File upload failed.' => 'Fallo al subir la imagen',
    'Home' => 'Inicio',
    'Invalid data received for parameter "{param}.' => '',
    'Login Required' => 'Requiere Logearse',
    'Missing required arguments: {params}' => '',
    'Missing required parameters: {params}' => '',
    'No' => '',
    'No results found.' => 'Sin resultado encontrados',
