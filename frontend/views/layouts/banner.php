						...
						<ul class="slides">
							<li>
								<div class="slider-info">
									<img src="<?= Yii::getAlias('@imgGovihar').'/1.jpg'?>" alt="">
								</div>
							</li>
							<li>
								<div class="slider-info">
									<img src="<?= Yii::getAlias('@imgGovihar').'/2.jpg'?>" alt="">
								</div>
							</li>
							<li>	
								<div class="slider-info">
									<img src="<?= Yii::getAlias('@imgGovihar').'/3.jpg'?>" alt="">
								</div>
							</li>
							<li>	
								<div class="slider-info">
                                                                    <img src="<?= Yii::getAlias('@imgGovihar').'/4.jpg'?>" alt="">
								</div>
							</li>
							<li>	
								<div class="slider-info">
